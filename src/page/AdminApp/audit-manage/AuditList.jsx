...
export default function AuditList(props) {
    ...
    useEffect(() => {
        axios(`/knowledge?author=${username}&auditState_ne=0&publishState_lte=1&_expand=category`).then(res => {
    ...
    const handleUpdate = (item) => {
        props.history.push(`/knowledge-manage/update/${item.id}`)
    }
