...
import { List, Avatar, Menu, Space, Input } from 'antd'
import {
    StarOutlined,
    LikeOutlined,
}
...
export default function ArticleList(props) {
    ...
    useEffect(() => {
        axios.get("/knowledge?publishState=2&_expand=category").then(res => {
            setlist(Object.entries(_.groupBy(res.data, item => item.category.title))[0][1])
            setFilterList(Object.entries(_.groupBy(res.data, item => item.category.title))[0][1])
        })
    }, [])
    const items = [
        {
